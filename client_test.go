...
import (
	...
	"github.com/miriambudayr/pet-project-30-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Pets.List(context.Background(), petproject30.PetListParams{})
	if userAgent != fmt.Sprintf("PetProject30/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Pets.List(context.Background(), petproject30.PetListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Pets.List(cancelCtx, petproject30.PetListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Pets.List(deadlineCtx, petproject30.PetListParams{})
		if err == nil {
