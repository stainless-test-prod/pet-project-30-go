...
// RequestOption is an option for the requests made by the pet-project-30 API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/miriambudayr/pet-project-30-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://petstore.swagger.io/api/")
}
