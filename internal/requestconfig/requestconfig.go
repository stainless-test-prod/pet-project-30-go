...
import (
	...
	"github.com/miriambudayr/pet-project-30-go/internal/apierror"
	"github.com/miriambudayr/pet-project-30-go/internal/apiform"
...
func getDefaultHeaders() map[string]string {
	return map[string]string{
		"User-Agent": fmt.Sprintf("PetProject30/Go %s", internal.PackageVersion),
	}
}
